...
val tennisConfiguration = listOf(
    ...
    GeckoPoseConfiguration(
        tag = "main_pose",
        pointConfigurations = listOf(
            PointConfiguration(PoseLandmark.LEFT_SHOULDER, color = Color.CYAN, selectedColor = Color.RED),
            PointConfiguration(PoseLandmark.LEFT_ELBOW, color = Color.CYAN, selectedColor = Color.RED),
            PointConfiguration(PoseLandmark.LEFT_WRIST, color = Color.CYAN, selectedColor = Color.RED),
            PointConfiguration(PoseLandmark.RIGHT_SHOULDER, color = Color.CYAN, selectedColor = Color.RED),
            PointConfiguration(PoseLandmark.RIGHT_ELBOW, color = Color.CYAN, selectedColor = Color.RED),
            PointConfiguration(PoseLandmark.RIGHT_WRIST, color = Color.CYAN, selectedColor = Color.RED),
            PointConfiguration(PoseLandmark.LEFT_HIP, color = Color.CYAN, selectedColor = Color.RED),
            PointConfiguration(PoseLandmark.RIGHT_HIP, color = Color.CYAN, selectedColor = Color.RED),
            PointConfiguration(PoseLandmark.LEFT_KNEE, color = Color.CYAN, selectedColor = Color.RED),
            PointConfiguration(PoseLandmark.RIGHT_KNEE, color = Color.CYAN, selectedColor = Color.RED),
            PointConfiguration(PoseLandmark.LEFT_ANKLE, color = Color.CYAN, selectedColor = Color.RED),
            PointConfiguration(PoseLandmark.RIGHT_ANKLE, color = Color.CYAN, selectedColor = Color.RED),
